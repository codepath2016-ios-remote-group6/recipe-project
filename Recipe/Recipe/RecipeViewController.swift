...
//        refreshRecipe()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        switch segue.identifier! {
            case "editSegue":
                let destinationViewController = segue.destination as! RecipeEditViewController
                destinationViewController.recipe = recipe
                destinationViewController.sourceAction = "edit"
            case "copySegue":
                let destinationViewController = segue.destination as! RecipeEditViewController
                destinationViewController.recipe = recipe
                destinationViewController.sourceAction = "copy"
