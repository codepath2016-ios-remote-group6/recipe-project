...
class Ingredient: NSObject {
    ...
    static let newIngredientName = "Modify your new ingredient"
...
//            alternativeText = String(quantity) + " " + unit + " of " + name
    ...
    class func makeAlternativeText(quantityString: String?, units: String?, name: String?) -> String{
        var preposition: String!
        if(units == ""){
            preposition = ""
        }else{
        ...
        var returnString = (quantityString ?? "")
        returnString += " "
        returnString += (units ?? "")
        returnString += preposition
        returnString += (name ?? "")
        return returnString
//        return (quantityString ?? "") + " " + (units ?? "") + preposition + (name ?? "")
    }
